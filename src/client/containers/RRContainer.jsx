...
class Sidebar extends Component {
    ...
    render() {
        const routes = [
            ...
            {
                path: '/home', 
                main:()=> this.props.isLoggedIn?(<div className='routerDisplays'>
                <h2>Home</h2>
                <Mantra/>
                </div>) : (<div className="LoginDisplays">
            ...
            {
                path: '/newentry', 
                main: ()=> this.props.isLoggedIn ? (<div className='JournalDisplays'>
                    <h2>Journal</h2>
                    <Entry/>
                </div>) : (<div className="LoginDisplays">
                    <h2>Not Logged In! Login here:</h2>
            ...
            {
                path: '/weeklyposts', 
                main: () => this.props.isLoggedIn? (<h2>Weekly</h2>) : (<div className="LoginDisplays">
                <h2>Not Logged In! Login here:</h2>
                <Login/>
            </div>)
            }
